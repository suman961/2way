  ...
  return (
    <div>
      <form onSubmit={handleSubmit(submitHandler)} className='h-100vh p-20'>
          ...
          <input {...register("name")} className='outline-0 border-0 text-2xl text-black font-light' type="text" placeholder='enter your name' /><hr />
          <input {...register("Email")} className='outline-0 border-0 text-2xl text-black font-light' type="Email" placeholder='enter email' /><hr />
          <input {...register("password")} className='outline-0 border-0 text-2xl text-black font-light' type="password" placeholder='********' /><hr />
